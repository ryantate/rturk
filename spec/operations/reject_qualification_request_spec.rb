...
describe RTurk::RejectQualificationRequest do
  ...
  it "should successfully request the operation" do
    ...
    RTurk::RejectQualificationRequest(:qualification_request_id => "123456789", :reson => "Your work is terrible!") rescue RTurk::InvalidRequest
  end
  
  it "should parse and return the result" do
    RTurk::RejectQualificationRequest(:qualification_request_id => "123456789", :reson => "Your work is terrible!").should be_a_kind_of RTurk::Response
